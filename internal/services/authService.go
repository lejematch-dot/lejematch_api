...
func sendWelcomeEmail(email, firstName string) error {
	...
	<html>
		<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto;">
			<div style="background-color: #006644; padding: 20px 24px;">
				<span style="color: #ffffff; font-size: 14px; font-weight: bold; letter-spacing: 2px; text-transform: uppercase;">LejeMatch</span>
			</div>
